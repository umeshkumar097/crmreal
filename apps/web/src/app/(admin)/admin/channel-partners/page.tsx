    ...
    <div style={{ minHeight: '100vh', background: '#F8FAFC', fontFamily: 'Inter, -apple-system, sans-serif' }}>
      <div style={{ background: '#fff', borderBottom: '1px solid #E2E8F0', padding: '18px 28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
          ...
          <span style={{ fontSize: 11, color: '#F59E0B', fontWeight: 600 }}>Channel Partners</span>
        </div>
        <h1 style={{ fontSize: 20, fontWeight: 800, color: '#0F172A' }}>🤝 Channel Partners</h1>
        <p style={{ fontSize: 13, color: '#64748B', marginTop: 2 }}>Manage partner accounts, commissions and referrals</p>
      </div>
