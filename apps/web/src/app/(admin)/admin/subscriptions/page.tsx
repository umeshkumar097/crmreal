    ...
    <div style={{ minHeight: '100vh', background: '#F8FAFC', fontFamily: 'Inter, -apple-system, sans-serif' }}>
      <div style={{ background: '#fff', borderBottom: '1px solid #E2E8F0', padding: '18px 28px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
          ...
          <span style={{ fontSize: 11, color: '#F59E0B', fontWeight: 600 }}>Subscriptions</span>
        </div>
        <h1 style={{ fontSize: 20, fontWeight: 800, color: '#0F172A' }}>📦 Subscriptions</h1>
        <p style={{ fontSize: 13, color: '#64748B', marginTop: 2 }}>View and manage tenant subscriptions</p>
      </div>
      <div style={{ padding: '60px 28px', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 14, color: '#64748B', maxWidth: 400 }}>Subscription management module is under development.</p>
